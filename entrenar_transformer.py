...
class TransformerModel:
    def __init__(self):
        ...
        print("✅ Transformer: Inicializado (sin entrenar)")
    ...
    def train(self, labels):
        ...
        print(f"✅ Transformer: Precisión validación: {val_acc:.2%}")
        ...
        print("✅ Transformer: Modelo guardado exitosamente")
        return True
    ...
    def load_model(self):
        ...
        if os.path.exists(p):
            try:
                ...
                self.is_trained=True
                print("✅ Transformer: Modelo cargado correctamente")
                return True
            except Exception as e:
                print(f"⚠️ Transformer: Error cargando modelo: {e}")
                return False
        else:
            print("⚠️ Transformer: No existe modelo guardado")
            return False
    ...
    def analyze_dataset(self,folder="data"):
        if not self.is_trained or self.model is None:
            print("❌ Transformer: Modelo no entrenado")
            return []
